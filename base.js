class Base extends Phaser.Scene {
  ...
  L1() {
    hiscore = localStorage.getItem("hiscore1") || 0;
  ...
  L2() {
    hiscore = localStorage.getItem("hiscore2") || 0;
  ...
  L3() {
    hiscore = localStorage.getItem("hiscore3") || 0;
  ...
  L4() {
    hiscore = localStorage.getItem("hiscore4") || 0;
  ...
  L5() {
    hiscore = localStorage.getItem("hiscore5") || 0;
  ...
  L6() {
    hiscore = localStorage.getItem("hiscore6") || 0;
